...
<html lang="pl">
    <head>
        ...
        <h1><title>Złożone zamówienie</title><h1>
    </head>

    <body>

    <header>
        <div class="logo"><h1>Gratulacje złożyłeś zamówienie</h1></div>
    ...
    <main>
        <div class="container">
                ...
                <article>
                    <div class="Gratulacje">Dziękujemy za złożenie zamówienia</div>
                    <div class="Gratulacje"><a href="index.php">Powrót do strony</a></div>
                </article>

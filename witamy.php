...
<html lang="pl">
    ...
    <header>
        <div class="logo"><h1>Strona powitalna</h1></div>
    ...
    <main>
        <div class="container">
                ...
                <article>
                    <div class="Gratulacje">Dziękujemy za rejestrację</div>
                    <div class="Gratulacje"><a href="strona_logowania.php">Zaloguj się na konto</a></div>
                </article>
